...
const blackListCellTemplate = (cellData) => {
    ...
    return `
    <span class="px-2 py-1 rounded-full text-xs font-semibold ${isBlacklisted
...
<template>
    <Teleport to="body">
                    ...
                    <div v-if="show"
                        ...
                        <div class="flex justify-between items-center mx-2 mt-4 px-4">
                            ...
                            <div class="flex gap-2">
                                ...
                                <button type="button" @click="handleSelectGuest"
                                    :disabled="!hasSearched || formattedGuests.length === 0" :class="[
                        ...
                        <div class="modal-body flex-1 overflow-hidden p-6">
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <div class="w-2/3 flex gap-2">
                                    <input type="text" id="searchInput" v-model="searchValue" @keypress="handleKeypress"
                            ...
                            <!-- Search By -->
                            <div
                                class="w-3/4 mx-auto flex justify-between items-center p-4 mb-6 bg-gray-50 rounded-lg border border-gray-200">
                                <div class="w-1/6 flex">
                                ...
                                <div class="w-1/5 flex">
                                    <div class="flex items-center">
                                        <input class="w-4 h-4 text-indigo-600 rounded focus:ring-indigo-500"
                                            type="checkbox" value="GuestName" v-model="selectedFields"
                                            id="searchGuestName" />
                                ...
                                <div class="w-1/6 flex">
                                    <div class="flex items-center">
                                        <input class="w-4 h-4 text-indigo-600 rounded focus:ring-indigo-500"
                                            type="checkbox" value="TypeIDNumber" v-model="selectedFields"
                                            id="searchIDNumber" />
                                ...
                                <div class="w-1/4 flex">
                                    <div class="flex items-center">
                                        <input class="w-4 h-4 text-indigo-600 rounded focus:ring-indigo-500"
                                            type="checkbox" v-model="selectAllFields" id="selectAllFields" />
                            ...
                            <div class="border border-gray-200 rounded-lg" style="height: 60vh;">
                                ...
                                <!-- No Results State -->
                                <div v-else-if="hasSearched && formattedGuests.length === 0"
                                    class="h-full flex flex-col items-center justify-center bg-gray-50 rounded-lg">
                                    <div class="text-center">
                                ...
                                <div v-else class="h-full">
                                    <DxDataGrid :data-source="dataGridDataSource" key-expr="clientID"
                                        :show-borders="true" :allow-column-reordering="true"
                                        :allow-column-resizing="true" :hover-state-enabled="true" :show-row-lines="true"
                                        :show-column-lines="true" :column-auto-width="false" :word-wrap-enabled="true"
                                        @selection-changed="handleSelectGuest" @row-dbl-click="onRowDblClick"
                            ...
                            <!-- Search Info -->
                            <div v-if="hasSearched && searchValue && searchValue.length >= 3 && !isLoading && !isLoadingInternal && formattedGuests.length > 0"
        ...
        <AddGuestModal :show="showAddGuestModal" @close="closeAddGuestModal" @save="handleGuestAdded" />
    </Teleport>
</template>
